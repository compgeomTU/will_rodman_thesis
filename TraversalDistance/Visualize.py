...
class Visualize(FreeSpaceGraph):
    ...
    def __init__(self, g1, g2, epsilon=50, log=False):
    ...
    def plot_freespace_cells(self, g1_ids=None, g2_ids=None):
        self.__build_graphs()
    ...
    def plot_cell_boundaries(self, g1_ids=None, g2_ids=None):
        self.__build_graphs()
        ...
        for g2_id, g2_edge in g2_edges.items():
            for g1_id, g1_edge in g1_edges.items():
                ...
                if len(points) >= 4: 
                    ...
                    xs, ys = list(zip(*points))    
                    plt.fill(xs, ys, alpha=0.3, fc='r', ec='none')
